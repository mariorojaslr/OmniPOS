...
<div class="container-fluid px-4 pb-5" x-data="presupuestoForm()">
    ...
    {{-- EXTREME COMPACT HEADER (MODO STOCK) --}}
    <div class="mb-2 mt-3 d-flex justify-content-between align-items-center">
        <div>
            <h1 class="fw-bold mb-0" style="font-size: 1.6rem; letter-spacing: -0.5px; color: #111827;">
                Nueva Referencia Comercial <span class="badge bg-light text-dark ms-2 border small" style="font-size: 0.6rem; font-weight: 400;">REF #{{ str_pad(($ultimoId ?? 0) + 1, 6, '0', STR_PAD_LEFT) }}</span>
            </h1>
            <p class="text-muted small mb-0">Generación ágil de cotización profesional</p>
        </div>
    ...
    <form action="{{ route('empresa.presupuestos.store') }}" method="POST" class="bg-white border rounded-3 shadow-sm p-3">
        @csrf
        ...
        <div class="row g-2 mb-2">
            ...
            <div class="col-md-3">
                ...
                <input type="date" name="fecha" class="form-control form-control-sm border-secondary-subtle" value="{{ date('Y-m-d') }}" required>
            </div>
            <div class="col-md-2">
                <label class="form-label small fw-bold mb-1" style="color: #111827;">Validez (Días)</label>
                <input type="number" name="validez" class="form-control form-control-sm border-secondary-subtle" value="15" required>
            </div>
        </div>

        {{-- INFO DEL CLIENTE LONGITUDINAL (3mm más arriba / A pedido) --}}
        ...
        {{-- GRILLA DE PRODUCTOS CON SCANNER --}}
                        ...
                        <tr class="border-bottom">
                            <td class="ps-2 py-1">
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text bg-white border-end-0 text-muted" title="Scanner de Código de Barras">
        ...
        <button type="button" @click="addItem()" class="btn btn-success btn-sm px-3 fw-bold shadow-sm rounded-pill mb-4 mt-2">
        ...
        <div class="row g-3 align-items-end">
            <div class="col-md-7">
                ...
                <textarea name="notas" class="form-control border-secondary-subtle" rows="2" placeholder="Algún comentario especial..." style="font-size: 0.8rem;"></textarea>
            </div>
            <div class="col-md-5 text-end">
                <div class="p-3 bg-light rounded-3 border">
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-2">
                        <button type="submit" name="status" value="borrador" class="btn btn-light btn-sm px-4 border text-muted">GUARDAR BORRADOR</button>
                        <button type="submit" name="status" value="pendiente" class="btn btn-success btn-sm px-4 fw-bold shadow-sm">
