...
Route::middleware(['auth', 'empresa', 'empresa.activa'])
     ...
     */
        ...
        Route::get('/remitos', [App\Http\Controllers\Empresa\RemitoController::class, 'index'])->name('remitos.index');
     ...
     */
        ...
        Route::get('/ordenes-pedido/create', [\App\Http\Controllers\Empresa\OrdenPedidoController::class, 'create'])->name('ordenes-pedido.create');
        Route::post('/ordenes-pedido', [\App\Http\Controllers\Empresa\OrdenPedidoController::class, 'store'])->name('ordenes-pedido.store');
        Route::get('/ordenes-pedido/{id}', [\App\Http\Controllers\Empresa\OrdenPedidoController::class, 'show'])->name('ordenes-pedido.show');
...
Route::get('/portal/cliente/{token}', [\App\Http\Controllers\ClientPortalController::class, 'index'])->name('client.portal');
Route::get('/portal/cliente/{token}/invoice/{id}', [\App\Http\Controllers\ClientPortalController::class, 'downloadInvoice'])->name('client.portal.invoice');
